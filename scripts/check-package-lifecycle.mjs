...
if (process.platform !== "darwin") {
  ...
  try {
    ...
    assert(
      priorDatabase.pragma("user_version", { simple: true }) === 1,
    ...
    assert(
      migratedDatabase.pragma("user_version", { simple: true }) === 1,
    ...
    futureDatabase.pragma("user_version = 2");
    ...
    assert(
      futureUnchanged.pragma("user_version", { simple: true }) === 2,
