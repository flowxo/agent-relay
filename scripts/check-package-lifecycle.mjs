...
if (process.platform !== "darwin") {
  ...
  try {
    ...
    assert(
      migratedDatabase.pragma("user_version", { simple: true }) === 3,
    ...
    futureDatabase.pragma("user_version = 4");
    ...
    assert(
      futureUnchanged.pragma("user_version", { simple: true }) === 4,
