...
if (!isSupportedReleaseRuntime(release, currentReleaseRuntime())) {
  ...
  try {
    ...
    assert(
      priorDatabase.pragma("user_version", { simple: true }) === 12,
    ...
    assert(
      migratedDatabase.pragma("user_version", { simple: true }) === 12,
    ...
    futureDatabase.pragma("user_version = 13");
    ...
    assert(
      futureUnchanged.pragma("user_version", { simple: true }) === 13,
