...
| ------- | ---------- | ---------------------- | --------------------- | --------------------- | --------------------- | --------------------- | --------------------- | --------------------- | ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| codex   | cli        | codex-cli 0.145.0      | verified              | compatible-unverified | compatible-unverified | verified              | unsupported           | unsupported           | unsupported         | [fixture 1](../packages/harnesses/fixtures/codex/session-start.json), [fixture 2](../packages/harnesses/fixtures/codex/user-prompt-submit.json), [fixture 3](../packages/harnesses/fixtures/codex/stop.json), [record](harness-evidence.md#live-harness-activation)                                                                                                                                                        |
| codex   | app-server | codex-cli 0.145.0      | verified              | verified              | verified              | verified              | verified              | verified              | verified            | [fixture 1](../packages/codex-app-server-driver/fixtures/codex-app-server-0.145.0/contract.json), [fixture 2](../packages/codex-app-server-driver/fixtures/codex-app-server-0.145.0/transcript.json), [fixture 3](../packages/codex-app-server-driver/fixtures/codex-app-server-0.145.0/live-canary.json), [record](harness-evidence.md#codex-app-server-structured-profile)                                               |
| claude  | cli        | 2.1.219 (Claude Code)  | verified              | compatible-unverified | compatible-unverified | verified              | unsupported           | compatible-unverified | unsupported         | [fixture 1](../packages/harnesses/fixtures/claude/session-start.json), [fixture 2](../packages/harnesses/fixtures/claude/user-prompt-submit.json), [fixture 3](../packages/harnesses/fixtures/claude/stop.json), [fixture 4](../packages/harnesses/fixtures/claude/stop-background-work.json), [fixture 5](../packages/harnesses/fixtures/claude/stop-failure.json), [record](harness-evidence.md#live-harness-activation) |
